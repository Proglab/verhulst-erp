...
*/
        ...
        $response = match ($pageName) {
            Crud::PAGE_EDIT => [$firstname, $lastname, $lang, $sex, $email, $phone, $gsm, $userStreet, $userPc, $userCity, $userCountry, $fonction, $interest, $user, $greeting],
            Crud::PAGE_NEW => [$firstname, $lastname, $lang, $sex, $email, $phone, $gsm, $userStreet, $userPc, $userCity, $userCountry->setFormTypeOption('preferred_choices', ['BE']), $fonction, $interest, $userAdd],
