...
*/
        ...
        $response = match ($pageName) {
            ...
            Crud::PAGE_NEW => [$firstname, $lastname, $lang, $sex, $email, $phone, $gsm, $userStreet, $userPc, $userCity, $userCountry->setFormTypeOption('preferred_choices', ['BE']), $fonction, $interest],
