...
{
    public function __construct(private CompanyContactRepository $companyContactRepository, private AdminUrlGenerator $adminUrlGenerator)
    {
    }
    ...
    protected function getRedirectResponseAfterSave(AdminContext $context, string $action): RedirectResponse
    {
        ...
        $url = $this->adminUrlGenerator->setDashboard(DashboardController::class)
            ...
            ->setEntityId($note->getCompanyContact()->getId())
        ->generateUrl();
