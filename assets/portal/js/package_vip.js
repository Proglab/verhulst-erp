...
$(function() {
    console.log('package_vip.js > ready');
    
    var commission_percent = $("#ProductPackageVip_percent_vr");
    var price_buy = $("#ProductPackageVip_pa");
    var price_sale = $("#ProductPackageVip_ca");
